...
//                         ? _myMembershipTier.color.withValues(alpha:0.15)
//                         : AppColors.surface,
//                   ),
//                   child: Icon(
...
//                     child: Container(height: heights[i], width: 3, decoration: BoxDecoration(color: AppColors.primary.withValues(alpha:0.5), borderRadius: BorderRadius.circular(2))),
//                   );
//                 }),
//                 const Spacer(),
//                 ValueListenableBuilder<int>(
...
//             child: Container(
//               width: 36, height: 36,
//               decoration: BoxDecoration(shape: BoxShape.circle, color: isMine ? Colors.white.withValues(alpha:0.2) : AppColors.primary.withValues(alpha:0.1)),
